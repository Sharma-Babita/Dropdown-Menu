...
function Dropdown() {
  ...
  // Used a hook for showing the selected Item
  ...
  // This function will fire , when we click outside of that select button
  const handleClick = ()=>{
    setOptionArray([]);
  }
  // This function take care of the selected Item
